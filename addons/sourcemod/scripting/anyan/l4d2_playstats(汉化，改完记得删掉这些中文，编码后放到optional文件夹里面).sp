...
void GetFunFactChatString(char[] printBuffer, const int iLen, bool bRound = true, bool bTeam = true, int iTeam = -1)
{
	...
	{
		case FFACT_TYPE_CROWN: {
			Format(printBuffer, iLen, "[%s秒妹玩家] \x04%s \x01秒了 \x05%d \x01只\x05妹。\n",
				(bRound) ? "对抗" : "游戏",
		...
		case FFACT_TYPE_DRAWCROWN: {
			Format(printBuffer, iLen, "[%s引秒玩家] \x04%s \x01引秒了 \x05%d \x01只\x05妹。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_SKEETS: {
			Format(printBuffer, iLen, "[%s空爆玩家] \x04%s \x01空爆了 \x05%d \x01只\x05Hunter。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_MELEESKEETS: {
			Format(printBuffer, iLen, "[%s刀爆玩家] \x04%s \x01近战空爆 \x05%d \x01只\x05Hunter。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick],
		...
		case FFACT_TYPE_M2: {
			Format(printBuffer, iLen, "[%s推特玩家] \x04%s \x01被吓得猛推 \x05%d \x01次特感。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_MELEETANK: {
			Format(printBuffer, iLen, "[%s刀克玩家] \x04%s \x01刀了 \x05%d \x01次\x05Tank。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_CUT: {
			Format(printBuffer, iLen, "[%s砍舌玩家] \x04%s \x01砍舌自救 \x05%d \x01次。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_POP: {
			Format(printBuffer, iLen, "[%s推胖玩家] \x04%s \x01推了 \x05%d \x01次\x05胖子。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_DEADSTOP: {
			Format(printBuffer, iLen, "[%s推HT玩家] \x04%s \x01推停了 \x05%d \x01只\x05Hunters。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_LEVELS: {
			Format(printBuffer, iLen, "[%s刀牛玩家] \x04%s \x01近战秒杀了 \x05%d \x01只\x05牛。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		// infected
		case FFACT_TYPE_HUNTERDP: {
			Format(printBuffer, iLen, "[%s 25 HT] \x04%s \x01飞天大草了 \x05%d \x01次\x05生还者。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_JOCKEYDP: {
			Format(printBuffer, iLen, "[%s高扑猴] \x04%s \x01l从高处骑了 \x05%d \x01次\x05生还者。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_DCHARGE: {
			Format(printBuffer, iLen, "[%s打秒牛] \x04%s \x01冲锋秒了 \x05%d \x01 个\x05生还者。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick],
				(wTypeHighVal[wPick] == 1) ? "" : "s"
		...
		case FFACT_TYPE_SCRATCH: {
			Format(printBuffer, iLen, "[%s扣扣王] \x04%s \x01扣了生还者共 \x05%d \x01点\x05伤害（仅生还者站立状态受到的伤害）。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_BOOMDMG: {
			Format(printBuffer, iLen, "[%s一喷四] \x04%s \x01喷人引来的小丧尸对生还者造成了共 \x05%d \x01点\x05伤害（仅生还者站立状态受到的伤害）。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
		...
		case FFACT_TYPE_SPITDMG: {
			Format(printBuffer, iLen, "[%s电梯痰] \x04%s \x01对生还者造成了共 \x05%d \x01点口水\x05伤害（仅生还者站立状态受到的伤害）。\n",
				(bRound) ? "对抗" : "游戏",
				g_sPlayerName[ wTypeHighPly[wPick] ],
				wTypeHighVal[wPick]
			);
